...
<li class="me-2">
    ...
    @class="{
        ...
        'border-transparent hover:text-gray-600 hover:border-gray-300': tab !== '{{ $tab }}' && !{{ $error ? 'true' : 'false' }}
    }"
    class="inline-flex items-center justify-center p-4 border-b-2 rounded-t-lg group transition-colors duration-200 {{ $error ? 'text-red-600 border-red-600' : '' }}"
